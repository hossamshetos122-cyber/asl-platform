...
export function Footer() {
  ...
  return (
    <footer className="border-t border-white/10 bg-bg-deep">
        ...
        <div className="grid grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-4">
          ...
          <div className="sm:col-span-2 lg:col-span-1">
            <div className="flex items-center gap-2.5 mb-3">
              <Image src="/images/league-logo.jpg" alt="شعار الدوري" width={1280} height={698} className="h-9 w-9 rounded-full object-cover border border-accent/20 flex-shrink-0" />
              <div>
                <div className="font-display text-sm font-black text-text">دوري نجوم الإسكندرية</div>
                <div className="font-utility text-[8px] tracking-[0.18em] text-accent/50 uppercase">Alexandria Amateur League</div>
              </div>
            </div>
            ...
            <p className="mt-3 font-utility text-[9px] tracking-[0.18em] text-accent/50 uppercase">الإسكندرية، مصر · Alexandria, Egypt</p>
          </div>
