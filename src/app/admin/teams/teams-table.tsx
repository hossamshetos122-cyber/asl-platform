      ...
      <td colSpan={5} className="px-4 py-3">
        ...
        >
          ...
          <div className="grid grid-cols-1 gap-4 sm:grid-cols-4">
            ...
            <div>
              ...
              <input
                ...
                required
                className="w-full rounded-lg border border-line bg-bg px-3 py-2.5 font-body text-sm text-text outline-none focus:border-accent"
              />
            </div>
            <div>
              <label className="mb-1.5 block font-utility text-[9px] tracking-[0.15em] text-text-dimmer uppercase">الاسم المختصر</label>
          ...
          <div className="mt-4 flex items-center gap-3">
            <button
              type="submit"
              className="rounded-lg bg-gradient-to-b from-accent to-accent-dim px-5 py-2 font-body text-[12px] font-black text-white transition-all hover:from-accent-bright hover:to-accent"
            >
              تحديث
            </button>
            <button
...
function TeamDeleteRow({ team, onEdit }: { team: TeamRow; onEdit: () => void }) {
  ...
  return (
    <tr className="transition-colors hover:bg-surface-elevated/50">
      ...
      <td className="px-4 py-3">
        <span className="inline-flex h-7 w-7 items-center justify-center rounded-md border border-line bg-surface-elevated font-utility text-[10px] font-bold text-accent">{team.shortName}</span>
      </td>
