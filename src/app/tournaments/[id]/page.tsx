    ...
    <>
      ...
      <section className="relative overflow-hidden bg-surface border-b border-line">
        ...
        <div className="page-container relative pt-10 sm:pt-14 pb-6 sm:pb-10">
          <Link href="/tournaments" className="mb-5 inline-flex items-center gap-1.5 py-2 -my-2 font-body text-sm font-bold text-accent hover:text-accent-bright transition-colors">
